...
目前 tkt 内置的信息类控件有 `Text`、`Image`、`Label`、`ProgressBar`、`Tooltip` 和 `Spinner`。
...
### 2.6 [`Spinner`](../../documents/standard/widgets.md#spinner)
...
tkt.Spinner(cv, (20, 20)).set(0.67)
tkt.Spinner(cv, (100, 20), mode="indeterminate")
