...
<p align="center"><small>图1 按钮控件</small></p>
...
=== ":fontawesome-brands-microsoft: Windows11 风格"
    ...
    ![light](images/2-2.light.png#only-light)
    ![dark](images/2-2.dark.png#only-dark)

=== ":fontawesome-brands-windows: Windows10 风格"

    ![light](images/2-2-win10.light.png#only-light)
    ![dark](images/2-2-win10.dark.png#only-dark)

<p align="center"><small>图2 开关控件</small></p>
...
=== ":fontawesome-brands-microsoft: Windows11 风格"
    ...
    ![light](images/2-3.light.png#only-light)
    ![dark](images/2-3.dark.png#only-dark)

=== ":fontawesome-brands-windows: Windows10 风格"

    ![light](images/2-3-win10.light.png#only-light)
    ![dark](images/2-3-win10.dark.png#only-dark)

<p align="center"><small>图3 开关按钮控件</small></p>
...
=== ":fontawesome-brands-microsoft: Windows11 风格"
    ...
    ![light](images/2-4.light.png#only-light)
    ![dark](images/2-4.dark.png#only-dark)

=== ":fontawesome-brands-windows: Windows10 风格"

    ![light](images/2-4-win10.light.png#only-light)
    ![dark](images/2-4-win10.dark.png#only-dark)

<p align="center"><small>图4 复选框控件</small></p>
...
=== ":fontawesome-brands-microsoft: Windows11 风格"
    ...
    ![light](images/2-5.light.png#only-light)
    ![dark](images/2-5.dark.png#only-dark)

=== ":fontawesome-brands-windows: Windows10 风格"

    ![light](images/2-5-win10.light.png#only-light)
    ![dark](images/2-5-win10.dark.png#only-dark)

<p align="center"><small>图5 单选框控件</small></p>
...
tkt.Slider(cv, (20, 20), default=1, command=root.alpha)
...
=== ":fontawesome-brands-microsoft: Windows11 风格"
    ...
    ![light](images/2-6.light.png#only-light)
    ![dark](images/2-6.dark.png#only-dark)

=== ":fontawesome-brands-windows: Windows10 风格"

    ![light](images/2-6-win10.light.png#only-light)
    ![dark](images/2-6-win10.dark.png#only-dark)

<p align="center"><small>图6 滑动条控件</small></p>
...
=== ":fontawesome-brands-microsoft: Windows11 风格"
    ...
    ![light](images/2-7.light.png#only-light)
    ![dark](images/2-7.dark.png#only-dark)

=== ":fontawesome-brands-windows: Windows10 风格"

    ![light](images/2-7-win10.light.png#only-light)
    ![dark](images/2-7-win10.dark.png#only-dark)

<p align="center"><small>图7 分段按钮控件</small></p>
...
![light](images/2-8.light.png#only-light)
![dark](images/2-8.dark.png#only-dark)

<p align="center"><small>图8 下划线按钮控件</small></p>
...
![light](images/2-9.light.png#only-light)
![dark](images/2-9.dark.png#only-dark)

<p align="center"><small>图9 高亮按钮控件</small></p>
...
=== ":fontawesome-brands-microsoft: Windows11 风格"
    ...
    ![light](images/2-10.light.png#only-light)
    ![dark](images/2-10.dark.png#only-dark)

=== ":fontawesome-brands-windows: Windows10 风格"

    ![light](images/2-10-win10.light.png#only-light)
    ![dark](images/2-10-win10.dark.png#only-dark)

<p align="center"><small>图10 图标按钮控件</small></p>
